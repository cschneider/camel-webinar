 ...
 * @version 
 */
public class PojoMessageInvocationHandler implements InvocationHandler {
    private static final transient Logger LOG = LoggerFactory.getLogger(PojoMessageInvocationHandler.class);
    ...
    protected static synchronized ExecutorService getExecutorService(CamelContext context) {
        ...
        if (executorService == null || executorService.isTerminated() || executorService.isShutdown()) {
            ...
            executorService = context.getExecutorServiceStrategy().lookup(PojoMessageInvocationHandler.class, "CamelInvocationHandler", "CamelInvocationHandler");
            if (executorService == null) {
                executorService = context.getExecutorServiceStrategy().newDefaultThreadPool(PojoMessageInvocationHandler.class, "CamelInvocationHandler");
            }
        }
